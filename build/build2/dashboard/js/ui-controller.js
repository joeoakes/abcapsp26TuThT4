...
const TELEMETRY_FEED_INTERVAL_MS = 210;
const TELEMETRY_MAX_QUEUE_SIZE = 100;
const TELEMETRY_MAX_LINES = 16;
const HUD_UPDATE_INTERVAL_MS = 300;
const HUD_DRIFT_CPU = 5;
const HUD_DRIFT_RAM = 4;
const HUD_DRIFT_CACHE = 7;
const HUD_MIN_CPU = 8;
const HUD_MIN_RAM = 10;
const HUD_MIN_CACHE = 6;
const HUD_MAX_CPU = 94;
const HUD_MAX_RAM = 95;
const HUD_MAX_CACHE = 92;
const LATENCY_TICK_INTERVAL_MS = 1200;
